...
```
@article{许亚芳2015基于激光扫描和迭代贝叶斯策略的定位研究,
  title   = {基于激光扫描和迭代贝叶斯策略的定位研究},
...
[Victoria Park data set](http://www.personal.acfr.usyd.edu.au/nebot/dataset.htm) and the satellite map. 
